...
function ProcessDetail() {
  ...
  const [processes, setProcesses] = useState(["FrontProcess"]);
      ...
      <Box sx={{ minWidth: 120, padding: "5px" }}>
        ...
        <div className="text">
          ...
          {Object.keys(conveyorBeltStatus).map((key, i) => {
            return (
              <div className="in" key={i} style={{ paddingTop: "10px" }}>
                <h3>
                  Spare Production {i + 1} : {conveyorBeltStatus[key]}
                </h3>

                <Box sx={{ width: "80%", paddingLeft: "5vmax" }}>
